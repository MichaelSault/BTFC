...
function Distance() {
  ...
  return (
    <>
      ...
      <meta name="description" content="Discover the Senior Distance program offered by the Burlington Track and Field Club, catering to runners of high school age and up. From training sessions to competitive events, find your perfect fit with us today!"/>
      <div className="teamRow">
        ...
        <div className="teamTextCol">
          <div className="teamTextSubCol">
            ...
            <a target="_blank" href='https://www.trackie.com/club/2026-burlington-track-field-club-outdoor-only/1036151/' className='teamButton'>REGISTER</a>
          </div>
